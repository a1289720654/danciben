...
public class MainActivity extends AppCompatActivity implements WordItemFragment.OnFragmentInteractionListener, WordDetailFragment.OnFragmentInteractionListener {
 ...
 @Override
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        WordsDB wordsDB=WordsDB.getWordsDB();//连接数库库
                        wordsDB.Insert(strWord, strMeaning, strSample);//插入数据库
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        WordsDB wordsDB=WordsDB.getWordsDB();
                        wordsDB.UpdateUseSql(strId, strWord, strNewMeaning, strNewSample);//重新插入，更新数据库
    ...
    private void SearchDialog() {//模糊查找
    ...
    public void onDeleteDialog(String strId) {
     ...
     @Override
    public void onUpdateDialog(String strId) {//更新数据库，判断自动排序是否存在
        WordsDB wordsDB=WordsDB.getWordsDB();
